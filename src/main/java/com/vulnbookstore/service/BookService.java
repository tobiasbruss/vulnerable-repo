...
public class BookService {
    ...
    // Allowed export formats — values are hardcoded, never user-supplied
    ...
    public String exportBookData(String format) {
        ...
        try {
            // Use array form to prevent shell injection; format is already validated above
            ...
            return "Export error: internal error";
        }
    }
