...
public class CryptoUtil {
    ...
    // AES-256 requires a 32-byte key. In production, load from a KMS or environment variable.
    private static final byte[] ENCRYPTION_KEY = Arrays.copyOf(
            "AES_KEY_PLACEHOLDER_32BYTES_HERE".getBytes(StandardCharsets.UTF_8), 32);
     ...
     * Expects the input to contain a prepended 12-byte GCM IV.
     *
