...
public class CryptoUtil {
    ...
    private static final byte[] ENCRYPTION_KEY = "AES_16BYTE_KEY!!".getBytes(StandardCharsets.UTF_8); // 16 bytes for AES-128
    ...
    public static String decrypt(String encryptedData) {
        try {
            ...
            // Extract IV from the first GCM_IV_LENGTH bytes
