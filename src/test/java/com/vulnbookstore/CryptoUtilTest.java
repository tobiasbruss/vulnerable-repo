 ...
 * using the secure algorithms: SHA-256 for hashing and AES-256-GCM for encryption.
 */
class CryptoUtilTest {
    ...
    void encrypt_useRandomIv_producesDifferentCiphertextEachTime() {
        // AES-GCM with a random IV should produce different ciphertext for each encryption
        String encrypted1 = CryptoUtil.encrypt("same data");
        String encrypted2 = CryptoUtil.encrypt("same data");

        // With a random IV, ciphertexts must differ
